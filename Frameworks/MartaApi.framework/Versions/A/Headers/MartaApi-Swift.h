...
/**
  Get the hex String value for this \code
  NSColor
  \endcode.
...
/**
  Parses the \code
  NSColor
  \endcode from the given \code
  hexString
  \endcode.
  Allowed String formats: “#rrggbb” or “#aarrggbb”.
*/
+ (NSColor * _Nonnull)fromHexString:(NSString * _Nonnull)hexString;
/**
...
*/
+ (NSColor * _Nonnull)fromHex:(NSInteger)hexInt useAlpha:(BOOL)useAlpha;
@end
